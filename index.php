...
<h3>News</h3>
<table>
	<!--<tr><td class='std col1 date'>2022-04-19</td><td class='std'><a href=""><img src="images/newsepjdatascience.jpg" width="64" height="64" alt="EPJ Data Science" class="logo"></a></td><td class='std'>Paper published in <a href="">EPJ Data Science</a> on Identifying urban features for vulnerable road user safety in Europe. See also the <a href="">blog post</a>.</td></tr>-->
